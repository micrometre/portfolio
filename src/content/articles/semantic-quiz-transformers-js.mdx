...
👉 [Semantic Quiz on GitHub](https://github.com/micrometre/embeddings)

🚀 [Live Demo](https://embeddings-virid.vercel.app/)
...
<div className="my-6 ">
  <h3 className="text-2xl font-bold mb-2 text-white">Further Readings & Experiments</h3>
</div>

<div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-xl p-6 my-8">
  <p className="text-gray-300 leading-relaxed">
    Interested in trying this in Python? Check out the <a href="https://github.com/micrometre/transformers-python" target="_blank" className="text-blue-400 hover:text-blue-300 font-medium">transformers-python</a> repository. It contains the Python version of these experiments, perfect for comparing client-side vs server-side implementations.
  </p>
</div>
