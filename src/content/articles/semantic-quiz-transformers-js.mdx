...
description: "Build an interactive quiz that grades free-text answers using semantic similarity all running 100% client-side with Transformers.js. "
...
<div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 my-12 shadow-xl backdrop-blur-sm">
  <h2 className="text-3xl font-bold mb-6 flex items-center gap-3 text-white">
    Moving Beyond Exact Matches: Semantic Answer Grading
  </h2>
...
Imagine a quiz that understands that "Paris is the capital of France" and "The capital of France is Paris" are semantically identical, awarding full credit to both. 


Follow this guide to build an interactive quiz featuring semantic answer grading, a technique made possible by Transformers.js.
...
| User Answer | Similarity | Grade |
|-------------|------------|-------|
| "Light scattering in the atmosphere makes blue visible" | 88% | Excellent |
| "Blue light scatters more than other colors" | 82% | Good |
| "Because of the sun" | 55% | Partial |
| "It just is" | 32% | Try Again |
